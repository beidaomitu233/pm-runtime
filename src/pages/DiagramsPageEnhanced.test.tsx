...
const diagram = { id: '01J00000000000000000000000', projectId: '01J00000000000000000000001', title: '客户流程', diagramType: 'flowchart' as const, orientation: 'horizontal' as const, status: 'ready' as const, currentRevisionNo: 2, warnings: [{ code: 'SOURCE_REF_MISSING', message: '缺少来源引用', path: '/sourceRefs' }], createdAt: '2026-09-21T00:00:00.000Z', updatedAt: '2026-09-21T00:00:00.000Z' }
...
describe('DiagramsPageEnhanced', () => {
  ...
  it('shows current revision, warning count and type filters', async () => {
    renderPage()
    expect(await screen.findByText('客户流程')).toBeInTheDocument()
    expect(screen.getByText('revision 2')).toBeInTheDocument()
    expect(screen.getByText('有 1 条 warning')).toBeInTheDocument()

...
export function MeetingDetailPageEnhanced() {
  ...
  const content = useQuery({ queryKey: ['meeting-content', meetingId, offset], queryFn: () => apiClient.getMeetingContent(meetingId!, offset), enabled: Boolean(meetingId && meeting.data?.importStatus === 'ready') })
